...
class BalenciagaVipMan
    ...
    ATTACK_LIST_URL = [#"https://www.alducadaosta.com/it/uomo/designer/fendi",
                        "https://www.russocapri.com/it/tutti/designer/chloe/gruppi"
    ...
    ATTACK_LIST_URL.each do |attack_site_url|
        case attack_site_url
         when "https://www.russocapri.com/it/tutti/designer/chloe/gruppi" then
            balenciaga_vip_man.russo_crawl(attack_site_url, @search_price)
            @search_price = @search_price.chomp(".00")
