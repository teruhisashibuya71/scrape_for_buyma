...
module BrunarossoWoman
    ...
    def select_brand_link(driver, brand_name, wait)
        ...
        when "ALEXANDER_MCQUEEN"
            ...
            return true
        when "BALENCIAGA"
            selenium_login(driver, wait)
            target_brand_xpath = '//*[@id="__nuxt"]/div/div[3]/div[2]/div/div/div[1]/div[3]/ul/li[26]/a'
        ...
        when "BALMAIN"
            ...
            el.click
        when "BOTTEGA_VENETA" #ログインが必要
            target_brand_xpath = '//*[@id="__nuxt"]/div/div[3]/div[2]/div/div/div[1]/div[3]/ul/li[34]/a'
            scroll_brand_window(driver, target_brand_xpath)
            el = driver.find_element(:xpath, target_brand_xpath)
            el.click
            return true
        when "CELINE"
            ...
            el.click
        when "NURBERRY"
            el = driver.find_element(:xpath, '//*[@id="__nuxt"]/div/div[3]/div[2]/div/div/div[2]/div[3]/ul/li[27]/a')
            el.click
        when "DSQUARED"
        ...
        when "GIVENCHY"
            ...
            el.click
        when "GOLDEN" #ログインなしでOK
            target_brand_xpath = '//*[@id="__nuxt"]/div/div[3]/div[2]/div/div/div[1]/div[3]/ul/li[80]/a'
            scroll_brand_window(driver, target_brand_xpath)
            el = driver.find_element(:xpath, target_brand_xpath)
            el.click
            return false
        when "HERNO"
            ...
            el.click
        when "JIMMY_CHOO"
            el = driver.find_element(:xpath, '//*[@id="__nuxt"]/div/div[3]/div[2]/div/div/div[2]/div[3]/ul/li[61]/a')
            el.click
        when "JW_ANDERSON"
            scroll_brand_window(driver)
            el = driver.find_element(:xpath, '//*[@id="__nuxt"]/div/div[3]/div[2]/div/div/div[1]/div[3]/ul/li[92]/a')
            el.click
            return false
        when "LANVIN"
            el = driver.find_element(:xpath, '//*[@id="__nuxt"]/div/div[3]/div[2]/div/div/div[1]/div[3]/ul/li[98]/a')
            el.click
            return false
        when "LOEWE"
        ...
        when "MARGIELA"
            el = driver.find_element(:xpath, '')
            el.click
        when "MARNI" #ログイン無しでOK
            target_brand_xpath = '/html/body/div/div/div[3]/div[2]/div/div/div[1]/div[3]/ul/li[115]/a'
            scroll_brand_window(driver, target_brand_xpath)
            el = driver.find_element(:xpath, target_brand_xpath)
            el.click
            return false
        ...
        when "STELLA" #ログインが必要
            selenium_login(driver, wait)
            target_brand_xpath = '//*[@id="__nuxt"]/div/div[3]/div[2]/div/div/div[1]/div[3]/ul/li[181]/a'
            scroll_brand_window(driver, target_brand_xpath)
            el = driver.find_element(:xpath, target_brand_xpath)
            el.click
            return true
        when "TODS" #ログインなし
            target_brand_xpath = '//*[@id="__nuxt"]/div/div[3]/div[2]/div/div/div[1]/div[3]/ul/li[191]/a'
            scroll_brand_window(driver, target_brand_xpath)
            el = driver.find_element(:xpath, target_brand_xpath)
            el.click
            return false
        ...
        when "TOM_FORD"
            ...
            el.click
        when "VALENTINO" #ログインが必要
            selenium_login(driver, wait)
            el = driver.find_element(:xpath, '//*[@id="__nuxt"]/div/div[3]/div[2]/div/div/div[1]/div[3]/ul/li[182]/a')
            el.click
            return true
        when "VALENTINO_GARAVANI"
            el = driver.find_element(:xpath, '//*[@id="__nuxt"]/div/div[3]/div[2]/div/div/div[2]/div[3]/ul/li[111]/a')
            el.click
        when "VERSACE"  #VERSACE_HOMEも?
            el = driver.find_element(:xpath, '//*[@id="__nuxt"]/div/div[3]/div[2]/div/div/div[2]/div[3]/ul/li[113]/a')
            el.click
        end
    end
    ...
    def brunarosso_crawl_selenium(brand_home_url, search_price, search_category, target_brand)
        ...
        if (page_link_elements.size == 1) then
            ...
            clowl_times.times do
                ...
                #上のソースではめずらしくtimeoutになるためsleepで対応
                sleep 5
            end
        end
    end
