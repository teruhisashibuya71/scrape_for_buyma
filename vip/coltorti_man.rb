...
module ColtortiMan
    ...
    def coltorti_return_category_page_url(attack_site_url, search_category)
        ...
        if search_category == "服" then
            attack_site_url = attack_site_url + "&cat=157"
            return attack_site_url
        elsif search_category == "靴" then
            attack_site_url = attack_site_url + "&cat=154"
            return attack_site_url
        elsif search_category == "バッグ" then
            attack_site_url = attack_site_url + "&cat=177"
            return attack_site_url
        else
            attack_site_url = attack_site_url + "&cat=152"
            return attack_site_url
        end
    end
