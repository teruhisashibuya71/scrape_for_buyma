...
module ColtortiWoman
    ...
    def coltorti_return_category_page_url(attack_site_url, search_category)
        ...
        if search_category == "服" then
            attack_site_url = attack_site_url + "&cat=167"
            return attack_site_url
        elsif search_category == "靴" then
            attack_site_url = attack_site_url + "&cat=211"
            return attack_site_url
        elsif search_category == "バッグ" then
            attack_site_url = attack_site_url + "&cat=181"
            return attack_site_url
        else
            attack_site_url = attack_site_url + "&cat=190"
            return attack_site_url
        end
    end
